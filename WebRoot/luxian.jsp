			...
			<div class="main-content">
				...
				<div class="page-content">
					<div class="page-header">
						<h1>
							管理 <small> <i class="icon-double-angle-right"></i> 查看所有路线
							</small>
						</h1>
					</div>
					<!-- /.page-header -->
						...
						<div class="col-xs-12">
							...
							<table class="table table-striped" align="left"
								...
								<tr class="container-flow"
									...
									<td class="col-lg-2">起始点</td>
									<td class="col-lg-2">终止点</td>
									<td class="col-lg-2">状态</td>
									<td class="col-lg-2">操作</td>
								</tr>
								<c:forEach var="Luxian" items="${list}">
									<tr style="text-align: center;">
										<td class="col-lg-2">${Luxian.id}</td>
										<td class="col-lg-2">${Luxian.qishi}</td>
										<td class="col-lg-2">${Luxian.zhongzhi}</td>
										<td class="col-lg-2">${Luxian.status}</td>
											<td class="col-lg-2"><a
											href="modifyLuxian?id=${Luxian.id }">修改</a></td>
									</tr>
								</c:forEach>
							</table>
							
							<ul class="pagination">
								<li class="disabled"><a href="findAllluxian?page=${param.page-1 }"> <i
										class="icon-double-angle-left"></i>
								</a></li>

								<li ><a href="findAllluxian?page=1">1</a></li>
								<c:forEach var="i" begin="2" end="${page }">

									<li ><a href="findAllluxian?page=${i }">${i }</a></li>
								</c:forEach>

								<li ><a href="findAlluxian?page=${param.page+1 }"> <i class="icon-double-angle-right"></i>
								</a></li>
							</ul>
