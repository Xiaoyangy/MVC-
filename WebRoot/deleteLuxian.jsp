						...
						<div class="col-xs-12">
							...
							<form >
								<div class="container">
									  ...
									  <div class="input-group " >
																	<input type="text" class="form-control search-query col-lg-4" placeholder="请输入起始地点" name="qishi">
							...
							<table class="table table-striped" align="left"
								...
								<tr class="container-flow"
									...
									<td class="col-lg-2">起始</td>
									<td class="col-lg-2">终止</td>
									<td class="col-lg-2">状态</td>
								</tr>
   <c:forEach var="Luxian" items="${requestScope.list }" >
								<tr class="container-flow"
									style="font-size:16px;font-family:微软雅黑; text-align:center">
