			...
			<div class="main-content">
				...
				<div class="page-content">
					<div class="page-header">
						<h1>
							管理 <small> <i class="icon-double-angle-right"></i>添加路线
							</small>
						</h1>
					</div>
					<!-- /.page-header -->
						...
						<div class="col-xs-12">
							...
							<div class="page-content">
								...
								<div class="row">
									...
									<form action="AddLuxian" method="post">
								<table class="table table-striped" align="left"
									...
									<tr>
										<td><input type="text" class="col-lg-12"
											placeholder="输入起始地" name="qishi"></td>
										<td><input type="text" class="col-lg-12"
											placeholder="输入终止地" name="zhongzhi"></td>
										<td><input type="text" class="col-lg-12"
											placeholder="输入状态" name="zhuangtai"></td>
