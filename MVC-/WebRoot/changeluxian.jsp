					...
					<div class="row">
						<div class="col-xs-12">
							...
							<table class="table table-striped" align="left"
								...
								<form action="modifyLuxian" method="post">
										<input type="hidden" name="id" value="${Luxian.id }">
											<tr style="text-align: center;">
										<td class="col-lg-2" ><input name="qishi" value="${Luxian.qishi}"></td>
										<td class="col-lg-2" ><input name="zhongzhi" value="${Luxian.zhongzhi}"></td>
										<td class="col-lg-2" ><input name="status" value="${Luxian.status}"></td>
